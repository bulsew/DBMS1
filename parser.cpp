...
QString Parser::parserfirst( QString text)
{
    ...
    QRegularExpression regex_drop("\\bdrop.+;", QRegularExpression::CaseInsensitiveOption);
 QRegularExpression regex_delete("\\bdelete.+;", QRegularExpression::CaseInsensitiveOption);
